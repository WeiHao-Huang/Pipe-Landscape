...
python /chenyupeng/old_files/yupeng_gpt/WSD/jaggi-lr/src/run_figures_visualizer.py --model_size 100M --n_points 10 --landscape_metric loss --save_path /chenyupeng/old_files/yupeng_gpt/WSD/jaggi-lr/src/save_file_100M --landscape_type 1D --landscape_drawing_ckpt 20000 21000 22000 23000 24000
