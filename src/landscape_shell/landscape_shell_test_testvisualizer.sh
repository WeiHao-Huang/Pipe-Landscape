...
python /huangweihao/projects/Pipe-Landscape/src/run_figures_visualizer.py --model_size 100M --n_points 5 --landscape_metric "loss"  --save_path /huangweihao/projects/Pipe-Landscape/src/save_file_100M --landscape_type 2D --landscape_drawing_ckpt 20000 21000 22000 23000 24000
