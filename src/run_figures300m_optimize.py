...
def load_ck_state(model, step):
    ...
    current_ckpt = torch.load(f"/chenyupeng/old_files/yupeng_gpt/WSD/river_valley_project/llama_360m/slimpajama_llama_nlayers24_nhead16_lr0.001_sched_wsd_warmup300_decay_linear_0.1_iter20000_bs50x1_ws4_seed0_data_seed1337/ckpts/{step}/main.pt",map_location=torch.device('cpu'))
    new_state_dict = {}
...
def plot_1D_landscape(step1, step2):
    ...
    plt.savefig(f'/chenyupeng/old_files/yupeng_gpt/WSD/jaggi-lr/src/save_file_300M/1d_landscape_{step1}_{step2}.png', dpi=600)
    plt.show()
...
def plot_2D_landscape(step1,step2,step3):
    ...
    plt.savefig(f'/chenyupeng/old_files/yupeng_gpt/WSD/jaggi-lr/src/save_file_300M/2d_landscape_{step1}_{step2}_{step3}.png', dpi=600)
...
for i in range(1000, 20000, 1000):
    print(f"run 1D landscape for step {i} and step {i+2000}")
