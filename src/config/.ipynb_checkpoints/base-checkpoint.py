...
#                       help="Local rank for distributed training")
    ...
    """
    Yupeng, 2025.5.19
    加入一个从2D landscape 中选择一个点resume 的方法，加入两个args： resume_from2 resum_from3, 且give 两个参数： alpha,  beta
    """
    parser.add_argument("--resume-from2", default=None, type=str)
    parser.add_argument("--resume-from3", default=None, type=str)
    ...
    """
    parser.add_argument("--resume_warmup", default=0, type=int)
    parser.add_argument(
        "--checkpoint_steps",
        type=int,
        nargs="+",
        default=[],
        help="List of iteration steps at which to save checkpoints, e.g., --checkpoint_steps 0 100 2500"
    )

    # parser.add_argument('--phase1-steps', type=int, default=3000, help='第一阶段结束的迭代次数')
    # parser.add_argument('--phase2-steps', type=int, default=27000, help='第二阶段结束的迭代次数')
    # parser.add_argument('--phase1-interval', type=int, default=300, help='第一阶段的保存间隔')
    # parser.add_argument('--phase2-interval', type=int, default=5000, help='第二阶段的保存间隔')
    # parser.add_argument('--phase3-interval', type=int, default=1000, help='第三阶段的保存间隔')
    ...
    parser.add_argument("--wsd-decay-steps", default=None, type=int,
                       help="Fixed number of steps for WSD decay (only used when wsd-fract-decay=0)")
    parser.add_argument(
        "--decay-type",
        default="linear",
