...
def plot_1D_landscape(step1, step2, lr):
    ...
    plt.savefig(f'/chenyupeng/old_files/yupeng_gpt/WSD/jaggi-lr/src/save_file_33M/Grad_1d_landscape_{step1}_{step2}.png', dpi=600,bbox_inches='tight')
    plt.show()
...
def plot_2D_landscape(step1,step2,step3, lr):
    ...
    plt.savefig(f'/chenyupeng/old_files/yupeng_gpt/WSD/jaggi-lr/src/save_file_33M/Grad_2d_landscape_{step1}_{step2}_{step3}.png', dpi=600,bbox_inches='tight')
...
for i in range(13000, 14000, 1000):
